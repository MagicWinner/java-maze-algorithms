...
public class Maze {
    ...
    public Maze() {
        cols = Math.floorDiv(WIDTH, 40);
        rows = Math.floorDiv(WIDTH, W);
    ...
    private void createAndShowGUI() {
        ...
        JSlider initialSpeedSlider = new JSlider(JSlider.HORIZONTAL, 1, 20, 1);
        JSlider genSpeedSlider = new JSlider(JSlider.HORIZONTAL, 1, 20, 1);
        JSlider solveSpeedSlider = new JSlider(JSlider.HORIZONTAL, 1, 20, 1);

        Hashtable<Integer, JLabel> labels = new Hashtable<Integer, JLabel>();
        labels.put(1, new JLabel("Fast"));
        labels.put(20, new JLabel("Slow"));
        ...
        runButton.addActionListener(event -> {
            ...
            frame.setTitle("Algorithm -> " + GENERATION_METHODS[genMethodsComboBox.getSelectedIndex()]);
        });
